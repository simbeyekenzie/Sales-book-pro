          ...
          {tabs.map((tab) => {
            ...
            return (
              <Link
                key={tab.name}
                href={tab.href}
                className={`group relative flex min-w-0 flex-1 flex-col items-center justify-center rounded-full px-2 py-1 text-[11px] transition-all duration-300 ${
                  isActive
                    ? "text-white"
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center">
                  <div
                    className={`mb-[1px] flex h-10 w-10 items-center justify-center rounded-full transition-all duration-300 ${
                      isActive
                  ...
                  <span
                    className={`truncate leading-none transition-all duration-300 ${
                      isActive
                  ...
                  <div
                    className={`mt-[2px] h-[3px] rounded-full transition-all duration-300 ${
                      isActive
